        ...
        try {
            ...
            grid.innerHTML += `
                <button onclick="window.kioskManager.submitVisit('General Staff')"
                    class="group bg-white dark:bg-slate-800 p-6 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-xl shadow-slate-200/50 transition-all flex flex-col items-center gap-4 text-center">
