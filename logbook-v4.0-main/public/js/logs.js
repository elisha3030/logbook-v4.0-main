            ...
            <tr class="hover:bg-slate-50/80 dark:hover:bg-slate-700/50 transition-colors group">
                ...
                <td class="px-6 py-5 text-center">
                    ...
                    : entry.status === 'pending'
                        ? `<span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-100 text-amber-600 text-[10px] font-black uppercase tracking-wider border border-amber-200 animate-pulse">
                             <div class="w-1.5 h-1.5 rounded-full bg-amber-500 animate-ping"></div> Pending
                           </span>`
